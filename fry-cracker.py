...
[70] DLITZ PBKDF2_SHA1
	"""
	ids=all_hash.split("\n")
	chosen=ids[int(hashtype) - 1]
	print(f"\n\033[1;36mCHOSEN HASHTYPE : {str(chosen)}")
	print(f"HASH : {hashed}")
	...
	if os.path.isfile(wordlist) and int(hashtype) <= 58:
		...
		if hashtype=='5':
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_argon2.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_bcrypt.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_bcrypt_sha256.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_des_crypt.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_disabled.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_pbkdf2_sha1.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_pbkdf2_sha256.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_salted_md5.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.django_salted_sha1.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
			...
			for passwd in words:
				word=passwd
				if passlib.hash.dlitz_pbkdf2_sha1.verify(word,hashed):
					print(f"HASH CRACKED : {hashed}")
					print(f"\033[1;36m PASSWORD :=> {passwd} \033[1;37m")
					print("<=========================================================================================================================>")
					print('FRY-CRACKER exited, bye bye')
